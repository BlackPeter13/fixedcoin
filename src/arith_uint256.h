...
#ifndef FIXEDCOIN_ARITH_UINT256_H
#define FIXEDCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * FixedCoin only uses this "compact" format for encoding difficulty
...
#endif // FIXEDCOIN_ARITH_UINT256_H

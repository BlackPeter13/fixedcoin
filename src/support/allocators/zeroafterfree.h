...
#ifndef FIXEDCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define FIXEDCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // FIXEDCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H

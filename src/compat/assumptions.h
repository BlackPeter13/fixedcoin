...
#ifndef FIXEDCOIN_COMPAT_ASSUMPTIONS_H
#define FIXEDCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "FixedCoin cannot be compiled without assertions."
#endif
...
#endif // FIXEDCOIN_COMPAT_ASSUMPTIONS_H

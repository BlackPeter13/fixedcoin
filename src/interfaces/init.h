...
#ifndef FIXEDCOIN_INTERFACES_INIT_H
#define FIXEDCOIN_INTERFACES_INIT_H
...
//! (fixedcoin-gui, fixedcoin-node, fixedcoin-wallet, fixedcoind, fixedcoin-qt) and each
...
#endif // FIXEDCOIN_INTERFACES_INIT_H

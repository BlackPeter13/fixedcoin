...
#ifndef FIXEDCOIN_INTERFACES_NODE_H
#define FIXEDCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a fixedcoin node (fixedcoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or fixedcoin.conf.
...
#endif // FIXEDCOIN_INTERFACES_NODE_H

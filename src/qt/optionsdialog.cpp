      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->fixedcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->fixedcoinAtStartup);
    ...
    ui->fixedcoinAtStartup->setToolTip(ui->fixedcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->fixedcoinAtStartup->setText(ui->fixedcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openFixedCoinConfButton->setToolTip(ui->openFixedCoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new FixedCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->fixedcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSFIXontrols);
...
void OptionsDialog::on_openFixedCoinConfButton_clicked()
{

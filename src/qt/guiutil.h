...
#ifndef FIXEDCOIN_QT_GUIUTIL_H
#define FIXEDCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the FixedCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "fixedcoin:" URI into recipient object, return true on successful parsing

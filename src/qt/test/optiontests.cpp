...
{
    // Test regression https://github.com/fixedcoin/fixedcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/fixedcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/fixedcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/FixedCoin/FixedCoin-Qt.conf and all else left as default,
    // fixedcoin-qt should set both -listen and -listenonion to false and start successfully.

...
//! Entry point for FixedCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &FixedCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for FixedCoinGUI tests.
void AppTests::guiTests(FixedCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &FixedCoinGUI::consoleShown, this, &AppTests::consoleTests);

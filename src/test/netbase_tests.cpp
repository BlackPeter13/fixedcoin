...
{
    BOOST_CHECK(TestSplitHost("www.fixedcoincore.org", "www.fixedcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.fixedcoincore.org]", "www.fixedcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.fixedcoincore.org:80", "www.fixedcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.fixedcoincore.org]:80", "www.fixedcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:24768", "127.0.0.1", 24768));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:24768", "127.0.0.1", 24768));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:24768", "::ffff:127.0.0.1", 24768));
    BOOST_CHECK(TestSplitHost("[::]:24768", "::", 24768));
    BOOST_CHECK(TestSplitHost("::24768", "::24768", 0));
    BOOST_CHECK(TestSplitHost(":24768", "", 24768));
    BOOST_CHECK(TestSplitHost("[]:24768", "", 24768));
    ...
    BOOST_CHECK(TestSplitHost("www.fixedcoincore.org:65536", "www.fixedcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.fixedcoincore.org:0", "www.fixedcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.fixedcoincore.org:", "www.fixedcoincore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:24768", "127.0.0.1:24768"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:24768", "[::]:24768"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));

...
#ifndef FIXEDCOIN_TEST_SCRIPTNUM10_H
#define FIXEDCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from FixedCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // FIXEDCOIN_TEST_SCRIPTNUM10_H

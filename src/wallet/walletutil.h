...
#ifndef FIXEDCOIN_WALLET_WALLETUTIL_H
#define FIXEDCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! fixedcoin from opening the wallet, thinking it was newly created, and
...
#endif // FIXEDCOIN_WALLET_WALLETUTIL_H

...
#ifndef FIXEDCOIN_WALLET_TRANSACTION_H
#define FIXEDCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this fixedcoin node, and set to 0 for transactions that were created
...
#endif // FIXEDCOIN_WALLET_TRANSACTION_H

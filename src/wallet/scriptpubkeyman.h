...
#ifndef FIXEDCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define FIXEDCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The FixedCoin Core wallet was originally a collection of unrelated private
...
#endif // FIXEDCOIN_WALLET_SCRIPTPUBKEYMAN_H

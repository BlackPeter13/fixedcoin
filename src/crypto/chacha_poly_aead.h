...
#ifndef FIXEDCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define FIXEDCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@fixedcoin.
 *
 ...
 *
 * The chacha20-poly1305@fixedcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@fixedcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@fixedcoin are relatively fast in
...
#endif // FIXEDCOIN_CRYPTO_CHACHA_POLY_AEAD_H

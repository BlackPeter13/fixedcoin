...
#ifndef FIXEDCOIN_SCRIPT_STANDARD_H
#define FIXEDCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a fixedcoin address
 */
...
/**
 * Generate a FixedCoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // FIXEDCOIN_SCRIPT_STANDARD_H

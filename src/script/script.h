...
#ifndef FIXEDCOIN_SCRIPT_SCRIPT_H
#define FIXEDCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, FixedCoin always counted CHECKMULTISIGs
...
#endif // FIXEDCOIN_SCRIPT_SCRIPT_H

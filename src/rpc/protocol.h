...
#ifndef FIXEDCOIN_RPC_PROTOCOL_H
#define FIXEDCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in fixedcoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< FixedCoin is not connected
...
#endif // FIXEDCOIN_RPC_PROTOCOL_H

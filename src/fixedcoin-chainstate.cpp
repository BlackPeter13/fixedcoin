...
//
// The fixedcoin-chainstate executable serves to surface the dependencies required
// by a program wishing to use FixedCoin Core's consensus engine as it is right
// now.
//
// DEVELOPER NOTE: Since this is a "demo-only", experimental, etc. executable,
//                 it may diverge from FixedCoin Core's coding style.
//
// It is part of the libfixedcoinkernel project.

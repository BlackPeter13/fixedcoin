 ...
 */
#ifndef FIXEDCOIN_UTIL_SYSTEM_H
#define FIXEDCOIN_UTIL_SYSTEM_H
...
extern const char * const FIXEDCOIN_CONF_FILENAME;
extern const char * const FIXEDCOIN_SETTINGS_FILENAME;

...
#ifndef FIXEDCOIN_UTIL_SYSCALL_SANDBOX_H
#define FIXEDCOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during fixedcoind initialization if FixedCoin Core was compiled
...
#endif // FIXEDCOIN_UTIL_SYSCALL_SANDBOX_H

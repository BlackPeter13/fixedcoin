...
#ifndef FIXEDCOIN_UTIL_MESSAGE_H
#define FIXEDCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's fixedcoin address, it must refer to a public key.
...
#endif // FIXEDCOIN_UTIL_MESSAGE_H

...
#ifndef FIXEDCOIN_NODE_CONNECTION_TYPES_H
#define FIXEDCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/fixedcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on FixedCoin’s Peer-to-Peer Network")
...
#endif // FIXEDCOIN_NODE_CONNECTION_TYPES_H

FixedCoin Core version 0.13.2 is now available from:

  <https://fixedcoin.org/bin/fixedcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update fixedcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow fixedcoin-tx to create v2 transactions (fixdrak)

...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef FIXEDCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define FIXEDCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the fixedcoin network\n')
    ...
    g.write('#endif // FIXEDCOIN_CHAINPARAMSSEEDS_H\n')

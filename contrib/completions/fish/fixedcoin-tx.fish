...
# Extract options
function __fish_fixedcoin_tx_get_options
...
# Extract commands
function __fish_fixedcoin_tx_get_commands
...
# Add options
complete \
    --command fixedcoin-tx \
    --condition "not __fish_fixedcoin_seen_cmd (__fish_fixedcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_fixedcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command fixedcoin-tx \
    --arguments "(__fish_fixedcoin_tx_get_commands)" \
    --no-files

...
complete --command fixedcoind --no-files

# Extract options
function __fish_fixedcoind_get_options
...
complete \
    --command fixedcoind \
    --arguments "(__fish_fixedcoind_get_options --nofiles)"

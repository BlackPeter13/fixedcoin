...
"""Verify that starting fixedcoin with -h works as expected."""

from test_framework.test_framework import FixedCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(FixedCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fixedcoin with -h for help text")
        ...
        self.log.info("Start fixedcoin with -version for version information")
        ...
        self.log.info("Start fixedcoind with -fakearg to make sure it does not start")

...
By default, fixedcoind will dump mempool on shutdown and
...
class MempoolPersistTest(FixedCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent fixedcoind from writing mempool.dat to disk. Verify that `savemempool` fails")

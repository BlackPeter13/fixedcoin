...
Verify that a fixedcoind node can use an external signer command.
...
class RPCSignerTest(FixedCoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart fixedcoind with -signer=<cmd>',

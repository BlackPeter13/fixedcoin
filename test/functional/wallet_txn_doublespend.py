...
class TxnMallTest(FixedCoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 FIX:
        ...
        # First: use raw transaction API to send 1240 FIX to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 FIX coin each
        ...
        # Node0's balance should be starting balance, plus 50FIX for another
        ...
        # Node0's total balance should be starting balance, plus 100FIX for

...
"""
Test starting fixedcoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(FixedCoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that fixedcoind has bound on "::1" (for RPC) and "::" (for P2P).

...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/fixedcoin/fixedcoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(FixedCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our fixedcoind node")
